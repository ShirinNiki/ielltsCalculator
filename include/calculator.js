...
function initView() {
    ...
    <div id='hide2Text' >Please remember that we calculate these scores based on your own assessment of your strengths and weaknesses in different parts of the IELTS test. You are not guaranteed to get these score results in the actual test.</div>\
    <div class='calculator-upper'>\
        <div class='upper-title'>Listening and Reading score calculator</div>\
        </div>\
    <div class='div-content' id='calculator-2-1'>\
        <div class='row-left-description'>\
        <div class='content upper-text'>How many questions did you get right in the practice papers?</div>\
        </div>\
    <div class='row-select'>\
        <div class='ui image header'>\
        <div class='content '><div class='listening'></div>Listening</div>\
        <div class='content right-float color-listening'>\
        <input id='listening-score' class='cal-input' type='text' size='4' style='text-align: center;width:32px; font-size: 11pt; margin:2px'> of 40\
    </div>\
    </div>\
    </div>\
    <div class='row-select'>\
        <div class='ui image header'>\
        <div class='content'><div class='reading'></div>Reading</div>\
        <div class='content right-float color-reading'>\
        <input id='reading-score' class='cal-input' type='text' size='3' style='text-align: center;width:32px; font-size: 11pt; margin:2px'> of 40\
    </div>\
    </div>\
    </div>\
    <div class='row-left-description' style='margin-bottom:0px;'>\
        <div class='content upper-text' style='margin-top: 4px;'>Which exam are you taking?</div>\
    </div>\
    <div class='row-left-description'>\
    ...
    <div class='div-result' style='display: none'>\
        ...
        <div class='content color-grey' style='margin-top: 31px;margin-bottom: 21px;'>Your score:</div>\
        <div class='ui image header'>  <div class='content'><div class='listening'></div> Listening</div>\
            <div class='content middle' id='listening-band' style='font-size: 25pt;color: #383838;'></div>\
        </div>\
        <div class='ui image header'><div class='content'><div class='reading'></div> Reading&nbsp;&nbsp;</div>\
            <div class='content middle' id='reading-band' style='font-size: 25pt;color: #383838;margin-top: 0;'></div>\
        </div>\
        <div class='content color-grey' onmouseover='show2Text();' onmouseout='hide2Text();' style='margin-top: -2px;'><p>These scores are estimates only.</p></div>\
     \
    <button class='ui button second special btn-do-again' >Do it again.</button>\
    <br>\
    </div>\
    </div>\
    </div>";
    jQuery("#calculator-2").html(init_html);
